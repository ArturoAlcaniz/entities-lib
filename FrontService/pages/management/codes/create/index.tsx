...
import { handleObtainLimitedBy, handleChangeLimitedby, handleChangeCoins } from '@root/components/Management/ManagementLogic';
                ...
                <div className="pageCentered">
                    <div className="card createProductForm">
                        <div className="card-content">
                            ...
                            <div className="field">
                                <div className="control">
                                    <select className="select" value={limitedBy} onChange={handleChangeLimitedby.bind(this)} autoComplete="off">
